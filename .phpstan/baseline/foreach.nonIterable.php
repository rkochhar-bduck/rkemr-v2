...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type array\\<mixed\\>\\|false supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/custom_modules/oe-module-faxsms/src/EtherFax/FaxAccount.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/custom_modules/oe-module-faxsms/src/EtherFax/FaxReceive.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/custom_modules/oe-module-faxsms/src/EtherFax/FaxStatus.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type array\\<mixed, mixed\\>\\|string supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type array\\<OpenEMR\\\\Services\\\\Search\\\\ServiceField\\>\\|string supplied for foreach, only iterables are supported\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 3,
    'path' => __DIR__ . '/../../src/Services/FHIR/Serialization/FhirOrganizationSerializer.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 5,
    'path' => __DIR__ . '/../../src/Services/FHIR/Serialization/FhirPatientSerializer.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 4,
    'path' => __DIR__ . '/../../src/Services/FHIR/Serialization/FhirPractitionerSerializer.php',
];
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type mixed supplied for foreach, only iterables are supported\\.$#',
    'count' => 3,
...
$ignoreErrors[] = [
    'message' => '#^Argument of an invalid type array\\<OpenEMR\\\\Services\\\\Qdm\\\\PopulationSet\\>\\|null supplied for foreach, only iterables are supported\\.$#',
    'count' => 3,
